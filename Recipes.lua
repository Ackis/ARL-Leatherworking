...
function module:InitializeRecipes()
	local function AddRecipe(spell_id, genesis, quality)
		return private.addon:AddRecipe(spell_id, constants.PROFESSION_SPELL_IDS.LEATHERWORKING, genesis, quality)
	end
	local recipe
	...
	recipe:AddTrainer(1385, 1632, 3007, 3069, 3365, 3549, 3605, 3967, 4212, 4588, 5127, 5564, 5784, 8153, 11097, 11098, 16278, 16688, 16728, 17442, 18754, 18771, 19187, 21087, 26911, 26998, 28700, 29507, 29508, 29509, 33581, 33612, 33635, 33681, 47384, 47396, 47400, 47418, 47419, 47420, 47431, 48619, 53436, 57620, 65043, 65121, 66354, 85920)
	...
	recipe:AddFilters(F.ALLIANCE, F.HORDE)
	recipe:AddTrainer(1385, 1632, 3007, 3069, 3365, 3549, 3605, 3967, 4212, 4588, 5127, 5564, 5784, 8153, 11097, 11098, 16278, 16688, 16728, 17442, 18754, 18771, 19187, 21087, 26911, 26998, 28700, 29507, 29508, 29509, 33581, 33612, 33635, 33681, 53436, 65121, 66354, 85920)
	...
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.DPS)
	recipe:AddTrainer(1385, 1632, 3007, 3069, 3365, 3549, 3605, 3967, 4212, 4588, 5127, 5564, 5784, 8153, 11097, 11098, 16278, 16688, 16728, 17442, 18754, 18771, 19187, 21087, 26911, 26998, 28700, 29507, 29508, 29509, 33581, 33612, 33635, 53436, 65121, 66354, 85920)
	...
	recipe:SetItemFilterType("LEATHERWORKING_WRIST")
	recipe:AddFilters(F.ALLIANCE, F.HORDE)
	recipe:AddTrainer(1385, 1632, 3007, 3069, 3365, 3549, 3605, 3967, 4212, 4588, 5127, 5564, 5784, 8153, 11097, 11098, 16278, 16728, 17442, 18754, 18771, 19187, 21087, 26911, 26998, 28700, 29507, 29508, 29509, 33581, 33612, 33635, 33681, 53436, 65121, 66354, 85920)
	...
	recipe:SetItemFilterType("LEATHERWORKING_LEGS")
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.HEALER, F.CASTER)
	recipe:AddTrainer(1385, 1632, 3007, 3069, 3365, 3549, 3967, 4212, 4588, 5127, 5564, 5784, 8153, 11097, 11098, 16278, 16688, 16728, 17442, 18754, 18771, 19187, 21087, 26911, 26998, 28700, 29507, 29508, 29509, 33581, 33612, 33635, 33681, 53436, 65121, 66354, 85920)
	...
	recipe:SetItemFilterType("LEATHERWORKING_HANDS")
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.DPS)
	recipe:AddTrainer(3007, 3069, 3365, 4212, 5127, 5564, 7868, 7869, 17442, 21087, 26911, 26998, 28700, 29507, 29508, 29509, 33581, 33612, 33635, 53436, 65121, 66354, 85920)
	...
	recipe:SetItemFilterType("LEATHERWORKING_CHEST")
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.HEALER, F.CASTER)
	recipe:AddTrainer(3007, 3069, 3365, 4212, 5127, 5564, 7871, 17442, 21087, 26911, 26998, 28700, 29507, 29508, 29509, 33581, 33612, 33635, 53436, 65121, 66354, 85920)
	...
	recipe:SetItemFilterType("LEATHERWORKING_CHEST")
	recipe:AddFilters(F.ALLIANCE, F.HORDE)
	recipe:AddTrainer(3007, 3069, 3365, 4212, 5127, 5564, 17442, 21087, 26911, 26998, 28700, 29507, 29508, 29509, 33581, 33612, 33635, 53436, 65121, 66354, 85920)
	...
	recipe:SetItemFilterType("LEATHERWORKING_ITEM_ENHANCEMENT")
	recipe:AddFilters(F.ALLIANCE, F.HORDE)
	recipe:AddTrainer(1385, 1632, 3007, 3069, 3365, 3549, 3605, 3967, 4212, 4588, 5127, 5564, 5784, 8153, 11097, 11098, 16688, 16728, 17442, 18754, 18771, 19187, 21087, 26911, 26998, 28700, 29507, 29508, 29509, 33581, 33612, 33635, 33681, 53436, 65121, 66354, 85920)
	...
	recipe:SetItemFilterType("LEATHERWORKING_FEET")
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.DPS, F.CASTER, F.ARGENT_DAWN)
	...
	recipe:SetItemFilterType("LEATHERWORKING_SHOULDER")
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.TANK, F.ARGENT_DAWN)
	...
	recipe:SetItemFilterType("LEATHERWORKING_MATERIALS")
	recipe:AddFilters(F.ALLIANCE, F.HORDE)
	recipe:AddTrainer(3007, 3069, 3365, 4212, 5127, 5564, 17442, 18754, 18771, 19187, 21087, 26911, 26998, 28700, 29507, 29508, 29509, 33581, 33612, 33635, 33681, 53436, 65121, 66354, 85920)
	...
	recipe:SetItemFilterType("LEATHERWORKING_ITEM_ENHANCEMENT")
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.THE_ALDOR)
	...
	recipe:SetItemFilterType("LEATHERWORKING_HANDS")
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.DPS, F.TANK, F.HEALER, F.CASTER, F.THE_CONSORTIUM)
	...
	recipe:SetItemFilterType("LEATHERWORKING_WAIST")
	recipe:AddFilters(F.ALLIANCE, F.DPS, F.HEALER, F.CASTER)
	...
	recipe:SetItemFilterType("LEATHERWORKING_LEGS")
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.DPS, F.THE_SCRYERS)
	...
	recipe:SetItemFilterType("LEATHERWORKING_FEET")
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.DPS, F.THE_ALDOR)
	recipe:AddRepVendor(FAC.THE_ALDOR, REP.REVERED, 19321)
	...
	recipe:SetItemFilterType("LEATHERWORKING_CREATED_ITEM")
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.THE_SHATAR)
	...
	recipe:SetItemFilterType("LEATHERWORKING_BACK")
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.DPS, F.HEALER, F.CASTER, F.THE_VIOLET_EYE)
	...
	recipe:SetItemFilterType("LEATHERWORKING_CHEST")
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.DPS, F.CASTER, F.THE_VIOLET_EYE)
	...
	recipe:SetItemFilterType("LEATHERWORKING_MATERIALS")
	recipe:AddFilters(F.ALLIANCE, F.HORDE)
	recipe:AddTrainer(3007, 3069, 3365, 4212, 5127, 5564, 17442, 21087, 26911, 26961, 26996, 26998, 28700, 29507, 29508, 29509, 33581, 33612, 33635, 53436, 65121, 66354, 85920)
	...
	recipe:SetItemFilterType("LEATHERWORKING_FEET")
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.DPS, F.TANK, F.HEALER, F.CASTER, F.THE_ASHEN_VERDICT)
	recipe:AddRepVendor(FAC.THE_ASHEN_VERDICT, REP.HONORED, 37687)
	...
	recipe:SetItemFilterType("LEATHERWORKING_ITEM_ENHANCEMENT")
	recipe:AddFilters(F.ALLIANCE, F.HORDE)
	recipe:AddTrainer(3007, 3069, 3365, 3967, 4212, 4588, 5127, 5564, 17442, 21087, 26911, 26998, 28700, 29507, 29508, 29509, 33581, 33612, 33635, 53436, 65121, 66354, 85920)
	...
	recipe:SetItemFilterType("LEATHERWORKING_BACK")
	recipe:AddFilters(F.ALLIANCE, F.HORDE)
	recipe:AddTrainer(3007, 3069, 3365, 4212, 5127, 5564, 17442, 26911, 26998, 28700, 29507, 29508, 29509, 33581, 33612, 33635, 53436, 65121, 66354, 85920)
	...
	recipe:SetItemFilterType("LEATHERWORKING_ITEM_ENHANCEMENT")
	recipe:AddFilters(F.ALLIANCE, F.HORDE)
	recipe:AddTrainer(3007, 3069, 3365, 3967, 4212, 4588, 5127, 5564, 17442, 21087, 26998, 28700, 29507, 29509, 33581, 33612, 33635, 53436, 65121, 66354, 85920)
	...
	recipe:SetItemFilterType("LEATHERWORKING_ITEM_ENHANCEMENT")
	recipe:AddFilters(F.ALLIANCE, F.HORDE, F.GOLDEN_LOTUS)
